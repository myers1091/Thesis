...
\indent	It is also important to focus the beam to a small area, in order to maximize the collision rate. This is achieved by 
...
\caption[Integrated Luminosity]{Cumulative luminosity versus time delivered to ATLAS (green) and recorded by ATLAS (yellow) during stable beams for pp collisions at 13 TeV centre-of-mass energy in LHC Run 2.  (figure from the ATLAS Collaboration)}
\label{fig:lumi}
\end{center}
\end{figure}
