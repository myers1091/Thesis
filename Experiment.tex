...
\begin{figure}[h]
\begin{center}
\includegraphics*[width=0.90\textwidth] {figures/CERN_Accelerator_Complex}%Taken from https://cds.cern.ch/record/2119882
...
\begin{figure}[h]
\begin{center}
\includegraphics*[width=0.90\textwidth] {figures/Cross-section-of-a-LHC-superconducting-cryodipole-85}%Taken from http://cds.cern.ch/record/1129806/
...
\begin{figure}[H]
\begin{center}
\includegraphics*[width=0.90\textwidth] {figures/intlumivstimeRun2}%Taken from https://twiki.cern.ch/twiki/bin/view/AtlasPublic/LuminosityPublicResultsRun2
...
\begin{figure}[H]
\begin{center}
\includegraphics*[width=0.90\textwidth] {figures/mu_2015_2018}%Taken from https://twiki.cern.ch/twiki/bin/view/AtlasPublic/LuminosityPublicResultsRun2
...
\begin{figure}[h]
\begin{center}
\includegraphics*[width=0.90\textwidth] {figures/inner_3D}%Taken from ID TDR
...
%\begin{figure}[h]
%\begin{center}
%\includegraphics[width=0.49\textwidth]{figures/figures_chapter02_Overview_bVSlight__MV2c20}
%\includegraphics[width=0.49\textwidth]{figures/figures_chapter02_Overview_bVSc__MV2c20}
%\caption[Comparison of light-jet and c-jet rejection as a function of $b$-jet tagging efficiency]{Comparison of light-jet (left) and c-jet (right) rejection as a function of $b$-jet tagging efficiency for the Run 1 and Run 2 detector layouts.\cite{Abbott:2018ikt}}
%\end{center}
%\label{fig:iblbtag}
%\end{figure}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.8\textwidth]{figures/vertexing}
...
\begin{figure}[h]
\begin{center}
\includegraphics*[width=0.90\textwidth] {figures/figure1-2_b}%Taken from LAr TDR
...
\begin{figure}[h]
\begin{center}
\includegraphics*[width=0.90\textwidth] {figures/figure1-9.png}%Taken from LAr TDR
...
\begin{figure}[h]
\begin{center}
\includegraphics*[width=0.90\textwidth] {figures/run2TDAQ}%Taken from https://cds.cern.ch/record/2133909/files/ATL-DAQ-PROC-2016-003.pdf
